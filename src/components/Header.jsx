    ...
    <div className={styles.App}>;
      <header>
        ...
        <div className="headText container">
          <img src={headText1} className="headText-1" alt="HeadText 1" />
          <a href="https://github.com">HeadText 1</a>
          <img src={headText2} className="headText-2" alt="HeadText 2" />
          <a href="https://github.com">HeadText 2</a>
          <img src={headText3} className="headText-3" alt="HeadText 3" />
